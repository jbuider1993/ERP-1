    ...
    <div className={commonStyles.singleRowSearch}>
      <Form form={form}>
        <Row className={index.formRowDiv}>
          <Col span={6}>
            <FormItem {...formItemLayout} label="部门名称" name={"userName"}>
              <Input placeholder="请输入部门名称" size="default"/>
            </FormItem>
          </Col>
          <Col span={6}>
            <FormItem {...formItemLayout} label='部门编号' name={"phoneNumber"}>
              <Input placeholder="请输入部门编号" size="default"/>
            </FormItem>
          </Col>
          <Col span={6}>
